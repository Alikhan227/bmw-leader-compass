...
export const candidates: Candidate[] = [
  {
    ...
    reasoning: {
      "automotive-continuity": "Dr. Richter's 18-year tenure and deep process expertise make her the strongest continuity candidate. Her stakeholder network across the powertrain division ensures seamless transitions with minimal disruption.",
      ...
      "supply-chain-crisis": "Strong resilience and stakeholder management compensate for moderate execution speed. Her internal network enables rapid cross-functional coordination during crises.",
    },
  },
  {
    id: "c2",
    ...
    reasoning: {
      ...
      "supply-chain-crisis": "Strong execution speed but moderate resilience. His external perspective could bring fresh crisis management approaches, though onboarding time (60 days) is a concern.",
    },
  },
  {
    id: "c3",
    ...
    reasoning: {
      "automotive-continuity": "Okonkwo's balanced profile works for continuity but her external status and higher cost create unnecessary friction for a stability-focused role.",
  ...
  },
  {
    ...
    reasoning: {
      "automotive-continuity": "Weber is a strong continuity candidate with balanced traits. His internal status means zero onboarding friction, though his stakeholder network is narrower than Dr. Richter's.",
